...
{
    return ossl_rsa_padding_add_PKCS1_OAEP_mgf1_ex(NULL, to, tlen, from, flen, param, plen, NULL, NULL, get_seed);
}
...
int RSA_padding_check_PKCS1_OAEP(unsigned char *to, int tlen,
                                 ...
                                 const unsigned char *param, int plen, unsigned char* get_seed)
{
    return RSA_padding_check_PKCS1_OAEP_mgf1(to, tlen, from, flen, num, param, plen, NULL, NULL, get_seed);
}
                                      ...
                                      const EVP_MD *mgf1md, unsigned char* get_seed)
{
     ...
     */
    ERR_raise(ERR_LIB_RSA, RSA_R_OAEP_DECODING_ERROR);
    //err_clear_last_constant_time(1 & good); // fix
#endif
 cleanup:
